...
export class Wave {
    ...
    //shine,orbs
    visualize(data, canvas, options: any = {}) {
        //options
        ...
        if (options.matrix) {
            ...
            for (color in options.colors) {
                ...
                for (var point = 1; point <= waveSize; point++) {
                    var p: any = data[point + (color * waveSize)] * percent;
        ...
        if (options.flower) {
            ...
            for (var point = 1; point <= point_count; point++) {
                var p: any = (data[point] + min) * percent;
                var a = point * increase;
        ...
        if (options.star) {
            ...
            for (var point = 1; point <= point_count; point++) {
                var p: any = ((data[200 % point])) * percent;
                var a = point * increase;
        ...
        if (options.round_wave) {
            ...
            for (var point = 1; point <= point_count; point++) {
                var p: any = (data[350 % point]) * percent;
                var a = point * increase;
    ...
    fromStream(stream, canvas_id, options: any = {}, muted = true) {
